...
class HTMLDocumentUtil:
    ...
    def get_event_listeners_by_xpath(self, xpath: str) -> list:
        """This gets the event listeners using the Chrome devtools protocol

        Args:
            xpath (str): The xpath of the element to get event listeners on

        Returns:
            list: The list of events (as a map, this is not a list of Event objects yet)
        """
        try:
