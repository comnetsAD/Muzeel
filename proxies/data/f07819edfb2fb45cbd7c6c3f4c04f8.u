const CACHE_VERSION = '1.7.18.1';

const BASE_CACHE_FILES = [
    'https://dailytimes.com.pk/assets/uploads/2020/08/app-icon-192x192-1.png',
'https://dailytimes.com.pk/assets/uploads/2020/08/app-icon-512x512-1.png',

];

const OFFLINE_CACHE_FILES = [
     'https://dailytimes.com.pk/articles/',
];
...
const OFFLINE_PAGE = 'https://dailytimes.com.pk/articles/';
const NOT_FOUND_PAGE = 'https://dailytimes.com.pk/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://dailytimes.com.pk//wp-admin/');
//    },
];
